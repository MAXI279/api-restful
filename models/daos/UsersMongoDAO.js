...
class UsersMongoDAO extends MongoDBContainer {
  // static instance;
  constructor () {
    if (!UsersMongoDAO.instance) {
      super(collection, UserSchema)
      UsersMongoDAO.instance = this
      return this
    } else {
      return UsersMongoDAO.instance
    }
  }
  ...
  //   try {
  //     const document = await this.model.findOne({ twitterId }, {  __v: 0 }).lean();
  //     if (!document) {
  //       return null;
  //     } else  {
  //       return document;
